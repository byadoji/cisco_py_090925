...
from sqlalchemy.exec import SQLAlchemyError, IntegrityError
from exc import  EmployeeAlreadyExistError,EmployeeNotFoundError,DatabaseError
...
def create_employee(employee):
   try:
         ...
         logging.info("Employee created")
            ...
            session.rollback()
            logging.error("Duplicate employees id:%s",ex)
